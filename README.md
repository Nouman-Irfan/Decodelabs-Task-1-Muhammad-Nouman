...
```bash
git clone https://github.com/Nouman-Irfan/Decodelabs-Task-1-Muhammad-Nouman.git
```

### 2️⃣ Open the Project Folder

```bash
cd Decodelabs-Task-1-Muhammad-Nouman
```
...
========== ADD TASK ==========
Enter your task: Complete internship task
